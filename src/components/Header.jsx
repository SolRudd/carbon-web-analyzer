...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Main Header */}
      <header
        className="sticky top-0 z-50 bg-white/60 dark:bg-[#020f1e]/60 backdrop-blur
                   border-b border-slate-200 dark:border-slate-800
                   transition-colors duration-300"
      >
        <div
          className="relative max-w-[1400px] mx-auto flex items-center justify-between
                      px-4 py-3"
        >
          {/* Mobile: logo on left */}
          <Link to="/" className="md:hidden flex-shrink-0" aria-label="Go to homepage">
            <picture>
        ...
        {menuOpen && (
          <nav
            id="mobile-menu"
            className="md:hidden bg-white dark:bg-[#020f1e]
