...
export default function ScaleBar({ grade }) {
  ...
  return (
    <div className="relative mt-14 w-full max-w-2xl mx-auto">
      ...
      >
        <span className="text-blue-600 dark:text-blue-400 font-semibold text-xs sm:text-sm whitespace-nowrap">
          Global average
        </span>
        <span className="text-xl leading-none text-blue-600 dark:text-blue-400">
          ↙
        </span>
      </div>
      <div
        className="absolute -top-1"
        style={{ left: `${avgPct}%`, transform: "translateX(30%)" }}
      >
      ...
      {userIndex !== -1 && (
        <div
          className="absolute -top-3 flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-white shadow-xl border-4 border-white dark:border-slate-900"
