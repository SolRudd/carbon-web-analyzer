...
import { Link } from 'react-router-dom'; // ✅ Import Link for correct navigation
...
export default function NotFoundPage() {
  ...
  return (
    <>
      {/* ✅ SEO: Tell Google NOT to index this page */}
      <Helmet>
      ...
      <section className="relative flex min-h-[calc(100vh-80px)] items-center justify-center overflow-hidden bg-white px-4 py-20 text-center dark:bg-[#020f1e] transition-colors duration-300">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <motion.div
            ...
            className="absolute top-1/2 left-1/2 w-[50rem] h-[30rem] bg-green-400/20 rounded-full transform -translate-x-1/2 -translate-y-1/2 blur-3xl motion-safe:animate-pulse"
          />
          <motion.div
            animate={{ scale: [1.2, 1, 1.2], opacity: [0.1, 0.2, 0.1] }}
            transition={{ duration: 10, repeat: Infinity, ease: "easeInOut", delay: 2 }}
            className="absolute bottom-0 right-0 w-[50rem] h-[30rem] bg-blue-400/20 rounded-full transform translate-x-1/2 translate-y-1/2 blur-3xl motion-safe:animate-pulse"
          />
          <motion.div
            animate={{ rotate: 360 }}
            transition={{ duration: 60, repeat: Infinity, ease: "linear" }}
            className="absolute top-1/4 left-1/4 w-32 h-32 bg-gradient-to-r from-green-300/10 to-blue-300/10 rounded-full blur-xl motion-safe:animate-spin"
          />
          <motion.div
            animate={{ rotate: -360 }}
            transition={{ duration: 45, repeat: Infinity, ease: "linear" }}
            className="absolute bottom-1/4 right-1/4 w-24 h-24 bg-gradient-to-r from-emerald-400/10 to-teal-400/10 rounded-full blur-lg motion-safe:animate-spin"
          />
        </div>
        ...
        <div className="absolute inset-0 pointer-events-none motion-safe:animate-none">
          {[...Array(12)].map((_, i) => (
            <div
              key={i}
              className="absolute"
              style={{ left: `${10 + Math.random() * 80}%`, bottom: '5%' }}
            >
        ...
        >
          <motion.div variants={itemVariants} className="relative">
            <motion.div
              ...
              className="absolute inset-0 rounded-full border-2 border-green-400/30 motion-safe:animate-none"
            />
            <motion.div
              animate={{ scale: [1, 1.2, 1], opacity: [0.7, 0, 0.7] }}
              transition={{ duration: 2, repeat: Infinity, delay: 0.5 }}
              className="absolute inset-0 rounded-full border-2 border-green-500/40 motion-safe:animate-none"
            />
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <motion.h2 variants={itemVariants} className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-white leading-tight">
              This Page Has Gone{" "}
            ...
            <motion.p variants={itemVariants} className="max-w-lg text-lg md:text-xl text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 pt-4">
            {/* ✅ Link Fixed: Changed to <Link> for instant navigation */}
          ...
          <motion.div variants={itemVariants} className="pt-8 max-w-md">
