...
import { 
  ...
  FaLightbulb,
  FaServer,
  FaCertificate,   // <--- replaced FaBadge
  FaChartLine,
  FaCog,
  FaExternalLinkAlt,
  FaRocket,
...
const faqCategories = [
  ...
  },
  {
    id: "badge-api",
    title: "Badge & API",
    icon: <FaCertificate className="text-xl" />,  // <--- replaced here
    ...
    <div className="bg-white dark:bg-slate-950 text-slate-900 dark:text-white transition-colors duration-300">
      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-3/4 right-1/4 w-[500px] h-[500px] bg-blue-400/20 transform rotate-12 blur-2xl opacity-25 animate-pulse" />
          <div className="absolute bottom-1/4 left-3/4 w-[400px] h-[400px] bg-purple-400/20 transform -rotate-45 blur-2xl opacity-20 animate-pulse" />
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-green-500/10 to-green-600/10 border border-green-500/20 dark:border-green-400/20 rounded-2xl p-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              >
                <FaCertificate className="mr-2" /> {/* replaced FaBadge */}
                Get Your Badge
              </Link>
