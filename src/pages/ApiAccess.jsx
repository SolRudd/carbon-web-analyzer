...
export default function ApiAccess() {
  ...
  // ✅ SEO: Create the Service schema for the API page
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "serviceType": "Developer API",
    "name": "GreenTracer Carbon API",
    "description": "Integrate powerful carbon footprint analysis into your applications. Measure, track, and optimize digital sustainability at scale with our RESTful JSON API.",
    "provider": {
      "@type": "Organization",
      "name": "GreenTracer"
    },
    ...
    "offers": [
      {
        ...
        "price": "0",
        "priceCurrency": "USD",
        "description": "Free API access for academic research, non-profits, and open source projects. Up to 1,000 requests/month."
      },
      {
        "@type": "Offer",
        ...
        "price": "Custom",
        "priceCurrency": "USD",
        "description": "Custom pricing and unlimited requests tailored for your business needs, with SLA guarantees and priority support."
      }
    ]
  };
  ...
  return (
    <>
      {/* ✅ SEO: Full advanced Helmet setup for the API page */}
      <Helmet>
        {/* -- Primary Meta Tags -- */}
        <title>Developer API | GreenTracer Carbon Analysis</title>
        <meta name="description" content="Integrate powerful carbon footprint analysis into your applications with the GreenTracer RESTful API. Measure, track, and optimize digital sustainability at scale." />
        <link rel="canonical" href="https://www.greentracer.org/api" />

        {/* -- Open Graph / Facebook -- */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.greentracer.org/api" />
        <meta property="og:title" content="Developer API | GreenTracer Carbon Analysis" />
        <meta property="og:description" content="Integrate powerful carbon footprint analysis into your applications with the GreenTracer RESTful API." />
        <meta property="og:image" content="https://www.greentracer.org/your-social-share-image-for-api.jpg" />

        {/* -- Twitter -- */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://www.greentracer.org/api" />
        <meta property="twitter:title" content="Developer API | GreenTracer Carbon Analysis" />
        <meta property="twitter:description" content="Integrate powerful carbon footprint analysis into your applications with the GreenTracer RESTful API." />
        <meta property="twitter:image" content="https://www.greentracer.org/your-social-share-image-for-api.jpg" />
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-r from-green-500/10 to-green-600/10 border border-green-500/20 dark:border-green-400/20 rounded-2xl p-8">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-300 mb-8">
                Our team is here to help you integrate GreenTracer API into your project. 
