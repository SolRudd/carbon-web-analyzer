...
export default function ApiAccess() {
  return (
    <section className="bg-[#020f1e] text-white py-16 px-4 min-h-screen">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold mb-6 text-green-400">
          Website Carbon API
        </h1>
        ...
        <form className="space-y-4">
          <div className="flex gap-4">
            <input
              ...
              className="flex-1 p-3 rounded-md bg-slate-800 border border-slate-600 text-white"
              required
            />
            <input
              type="text"
          ...
          <input
            ...
            className="w-full p-3 rounded-md bg-slate-800 border border-slate-600 text-white"
            required
          />
          ...
          <button
            type="submit"
            className="bg-green-600 hover:bg-green-500 text-white font-semibold py-3 px-6 rounded-md transition"
          >
            Request Access
          </button>
        </form>
