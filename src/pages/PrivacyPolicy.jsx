        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          >
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-4">
              <em>Last updated: July 29, 2025</em>
            </p>
          </motion.section>
          ...
          >
            ...
            <ul className="list-disc list-inside text-lg text-slate-700 dark:text-slate-300 space-y-2 ml-4 mt-4">
              <li>By email: <a href="mailto:privacy@greentracer.com" className="text-greenbuzz dark:text-green-400 hover:underline">privacy@greentracer.com</a></li>
            </ul>
          </motion.section>
